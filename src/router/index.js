...
const routes = [
  ...
  //  todo: remove this
  {
    name: 'SitePreviewHome',
    path: '/apple-admin/site',
    component: () => import('../views/Home'),
    meta: {
      title: 'Apple`n`Perry',
      layout: 'home',
  ...
  {
    name: 'SitePreviewShopMain',
    path: '/apple-admin/site/shop',
    component: () => import('../views/Shop/Main'),
    meta: {
      title: 'Магазин',
      layout: 'shop',
  ...
  {
    name: 'SitePreviewShopCategories',
    path: '/apple-admin/site/shop/categories',
    component: () => import('../views/Shop/Categories/Categories'),
    meta: {
      title: 'Категории',
      layout: 'shop',
  ...
  {
    name: 'SitePreviewShopCategory',
    path: '/apple-admin/site/shop/categories/:type/:id',
    component: () => import('../views/Shop/Categories/Category'),
    meta: {
      layout: 'shop',
      needToken: true
  ...
  {
    name: 'SitePreviewShopProduct',
    path: '/apple-admin/site/shop/categories/:type/:id/:url',
    component: () => import('../views/Shop/Product'),
    meta: {
      layout: 'shop',
      needToken: true
  ...
  {
    name: 'SitePreviewShopProductStock',
    path: '/apple-admin/site/shop/stock/:url',
    component: () => import('../views/Shop/Product'),
    meta: {
      layout: 'shop',
      needToken: true
  ...
  {
    name: 'SitePreviewShopVendors',
    path: '/apple-admin/site/shop/vendors',
    component: () => import('../views/Shop/Vendors/Vendors'),
    meta: {
      title: 'Производители',
      layout: 'shop',
  ...
  {
    name: 'SitePreviewShopVendor',
    path: '/apple-admin/site/shop/vendors/:id',
    component: () => import('../views/Shop/Vendors/Vendor'),
    meta: {
      title: 'Производители',
      layout: 'shop',
  ...
  {
    name: 'SitePreviewShopVendorProduct',
    path: '/apple-admin/site/shop/vendors/:id/:url',
    component: () => import('../views/Shop/Product'),
    meta: {
      layout: 'shop',
      needToken: true
  ...
  {
    name: 'SitePreviewShopContacts',
    path: '/apple-admin/site/shop/contacts',
    component: () => import('../views/Shop/Contacts'),
    meta: {
      title: 'Контакты',
      layout: 'shop',
  ...
  {
    name: 'SitePreviewCart',
    path: '/apple-admin/site/shop/cart',
    component: () => import('../views/Shop/Cart'),
    meta: {
      title: 'Корзина',
      layout: 'shop',
  ...
  {
    name: 'SitePreviewShopDocs',
    path: '/apple-admin/site/shop/docs/:url',
    component: () => import('../views/Shop/DocumentPage'),
    meta: {
      layout: 'shop',
      needToken: true
  ...
  {
    name: 'SitePreviewShopStock',
    path: '/apple-admin/site/shop/stock',
    component: () => import('../views/Shop/Stock'),
    meta: {
      title: 'Ассортимент',
      layout: 'shop',
  ...
  {
    name: 'SitePreviewPages',
    path: '/apple-admin/site/pages/:url',
    component: () => import('../views/Page'),
    meta: {
      layout: 'other',
      needToken: true
  ...
  {
    name: 'SitePreviewAboutCider',
    path: '/apple-admin/site/about',
    component: () => import('@/views/AboutCider'),
    meta: {
      layout: 'other',
      title: 'О сидре и перри',
  ...
  {
    name: 'SitePreviewNews',
    path: '/apple-admin/site/news',
    component: () => import('@/views/News/Main'),
    meta: {
      layout: 'other',
      title: 'Новости',
  ...
  {
    name: 'SitePreviewNewsSection',
    path: '/apple-admin/site/news/:section',
    component: () => import('@/views/News/Main'),
    meta: {
      layout: 'other',
      title: 'Новости',
  ...
  {
    name: 'SitePreviewNewsPreview',
    path: '/apple-admin/site/news/:section/:newsUrl',
    component: () => import('@/views/News/NewsPreview'),
    meta: {
      layout: 'other',
      title: 'Новости',
